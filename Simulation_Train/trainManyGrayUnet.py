...
class RealMuraEnv:
    ...
    def step(self, action_gray_diff):
        ...
        # 辅助 Loss 权重可以小一点
        r_grad = - grad_loss * 2000.0*gray_weight
        r_action = - torch.mean(actual_delta ** 2) * 0.005

        reward = r_std + r_mse + r_grad
...
if __name__ == '__main__':
    TRAIN_GRAYS = [16, 32, 48, 64, 96, 128, 160, 192, 224]
    MAX_EPISODES = 8000
    STEPS = 8
    BATCH_SIZE = 32
    ...
    critic_opt = torch.optim.Adam(critic.parameters(), lr=2e-3)
